...
//        val CALLBACK_HANDLE_KEY = "CALLBACK_HANDLE_KEY"
        ...
        @JvmStatic
        val METHOD_PLUGIN_UPDATE_BACKGROUND_PERMISSION = "LocatorPlugin.updateBackgroundPermission"

        @JvmStatic
        val METHOD_PLUGIN_AVAILABLE_BACKGROUND_PERMISSION = "LocatorPlugin.availableBackgroundPermission"
        ...
        @JvmStatic
        val SETTINGS_NETWORK_URL = "settings_network_url"

        @JvmStatic
        val SETTINGS_NETWORK_METHOD = "settings_network_method"

        @JvmStatic
        val SETTINGS_NETWORK_HEADERS = "settings_network_headers"
