...
// part 'filter_approval_request_event.dart';
// part 'filter_approval_request_state.dart';

// class FilterApprovalRequestBloc
//     extends Bloc<FilterApprovalRequestEvent, FilterApprovalRequestFilterState> {
//   final UpdateProfileUseCase useCase;

//   FilterApprovalRequestBloc(this.useCase) : super(const FilterApprovalRequestFilterState());
