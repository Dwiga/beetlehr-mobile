...
class ClockOutOfflinePage extends StatefulWidget {
  const ClockOutOfflinePage({
    Key? key,
  ...
  @override
  _ClockOutOfflinePageState createState() => _ClockOutOfflinePageState();
}

class _ClockOutOfflinePageState extends State<ClockOutOfflinePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(S.of(context).clock_out + " " + S.of(context).offline),
      ),
