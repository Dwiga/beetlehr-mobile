...
///
/// Additionally there is no good API of obtaining content
///  length from interceptor
/// API so we're "approximating" the byte length based on headers
/// & request data.
/// If you're not fine with this, you can provide your own
/// implementation in the constructor
///
/// This interceptor might be counting parsing time into elapsed
/// API call duration.
